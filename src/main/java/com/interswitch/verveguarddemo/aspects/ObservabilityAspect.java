...
@ConditionalOnProperty(name = "verveguard.observability.enabled", havingValue = "true", matchIfMissing = true)
@Slf4j
@Aspect
@Component
public class ObservabilityAspect {

    @Around("@annotation(com.interswitch.verveguarddemo.annotation.Observed) " +
            "|| @within(com.interswitch.verveguarddemo.annotation.Observed)")
