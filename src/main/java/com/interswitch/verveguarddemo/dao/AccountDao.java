...
import com.interswitch.verveguarddemo.models.projections.MerchantAccountValidation;
...
public class AccountDao {
    ...
    @Caching(evict = {
            @CacheEvict(value = "account", key = "#params.values['id']"),
            @CacheEvict(value = "merchant-validation", allEntries = true)
    })
    ...
    @Cacheable(value = "merchant-validation", key = "#merchantId")
    ...
    @Cacheable(value = "merchant-id-by-user", key = "#userId")
