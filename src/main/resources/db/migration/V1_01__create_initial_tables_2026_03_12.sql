...
CREATE TABLE IF NOT EXISTS merchants (
    ...
    role_id         bigint                    NOT NULL,
    address         text,
    kyc_status      character varying(50)     NOT NULL,  -- PENDING, APPROVED, REJECTED
    merchant_status character varying(50)     NOT NULL,  -- ACTIVE, INACTIVE, SUSPENDED, DEACTIVATED
    tier            character varying(50)     NOT NULL,
    created_at      timestamp with time zone  NOT NULL DEFAULT now(),
    updated_at      timestamp with time zone  NOT NULL,
    deleted_at      timestamp with time zone           DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS cards (
    ...
    card_status character varying(50)     NOT NULL,  -- ACTIVE, EXPIRED
    created_at  timestamp with time zone  NOT NULL DEFAULT now(),
    updated_at  timestamp with time zone  NOT NULL,
...
CREATE TABLE IF NOT EXISTS fraud_attempts (
    id          bigint GENERATED BY DEFAULT AS IDENTITY,
    card_hash   character varying(64)     NOT NULL,  -- no FK, intentional
    merchant_id bigint                    NOT NULL,
